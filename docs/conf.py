...
"""
xblock-imagesgallery documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'xblock-imagesgallery',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/eduNEXT/xblock-imagesgallery",
...
#
# html_title = 'xblock-imagesgallery v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'ImagesGallery XBlock for open edX',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'imagesgallery'),
                os.path.join(root_path, 'imagesgallery/migrations')])
