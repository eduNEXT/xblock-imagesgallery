#!/usr/bin/env python
"""
Package metadata for imagesgallery.
"""
import os
import re
import sys
...
VERSION = get_version('imagesgallery', '__init__.py')
...
setup(
    name='xblock-imagesgallery',
    version=VERSION,
    description="""ImagesGallery XBlock for open edX""",
    long_description=README + '\n\n' + CHANGELOG,
    author='eduNEXT',
    author_email='technical@edunext.co',
    url='https://github.com/eduNEXT/xblock-imagesgallery',
    packages=find_packages(
        include=['imagesgallery', 'imagesgallery.*'],
        exclude=["*tests"],
    ),
